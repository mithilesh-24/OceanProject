...
def run_tests():
    ...
    print(f"[OK] Argo floats in DB: {argo_count}", flush=True)
    ...
    print(f"[OK] ADCP stations in DB: {adcp_count}", flush=True)
    ...
    print("[OK] /api/v1/observations/argo & /argo/{wmo_id} verified", flush=True)
    ...
    print("[OK] /api/v1/observations/gliders & /gliders/{id} verified", flush=True)
    ...
    print("[OK] /api/v1/observations/buoys & /buoys/{station_id} verified", flush=True)
    ...
    print("[OK] /api/v1/observations/ctd & /ctd/{cast_id} verified", flush=True)
    ...
    print("[OK] /api/v1/observations/adcp & /adcp/{station_id} verified", flush=True)
