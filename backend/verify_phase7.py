...
def run_tests():
    ...
    print(f"[OK] Numerical models in DB: {len(models)}", flush=True)
    ...
    print("[OK] All 3 foundational models (HYCOM, ROMS, NEMO) present in database", flush=True)
    ...
    print(f"[OK] HYCOM 0m Temperature Slice generated: {slice_hycom_t0['dimensions']} grid, min={slice_hycom_t0['min_value']} C, max={slice_hycom_t0['max_value']} C", flush=True)
    ...
    print(f"[OK] HYCOM 50m Velocity Slice & Vectors generated: {len(slice_hycom_vel['vectors'])} vector arrows", flush=True)
    ...
    print(f"[OK] Point Depth Profile extracted (BoB 14.28 N, 87.45 E): MLD={profile_bay['mixed_layer_depth_m']}m, Thermocline={profile_bay['thermocline_depth_m']}m", flush=True)
    ...
    print(f"[OK] Vertical Transect (Equatorial Zonal Section) generated: {len(transect_eq['depths'])} depth levels x {len(transect_eq['coords_points'])} coordinate points", flush=True)
    ...
    print("[OK] GET /api/v1/models returned 200 OK", flush=True)
    ...
    print("[OK] GET /api/v1/models/hycom returned 200 OK with depth levels", flush=True)
    ...
    print("[OK] GET /api/v1/models/hycom/slice returned 200 OK", flush=True)
    ...
    print("[OK] GET /api/v1/models/roms/profile returned 200 OK", flush=True)
    ...
    print("[OK] GET /api/v1/models/nemo/transect returned 200 OK", flush=True)
